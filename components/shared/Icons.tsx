...
export const BannerArrowIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 792 760" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path fill="currentColor" stroke="currentColor" strokeWidth="0" d="M 378 144 L 442 144 L 442 208 L 506 208 L 506 272 L 570 272 L 570 336 L 634 336 L 634 400 L 570 400 L 570 464 L 506 464 L 506 528 L 442 528 L 442 588.5 L 443 590.5 L 441.5 592 L 378 592 L 378 528 L 422.5 528 Q 424 525.5 429.5 527 L 431.5 528 L 433.5 528 L 441.5 528 L 442 527.5 L 442 464 L 506 464 L 506 400 L 122.5 400 L 122 399.5 L 122 336 L 505.5 336 L 506 335.5 L 506 273.5 L 504.5 272 L 442 272 L 442 208 L 378 208 L 378 144 Z " />
  </svg>
);
