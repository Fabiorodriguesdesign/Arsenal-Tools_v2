      ...
      >
        ...
        >
          <div className="absolute top-3 right-3 sm:top-4 sm:right-4 z-10">
            <button
                onClick={onClose}
                className="text-neutral-500 hover:text-neutral-800 dark:hover:text-white transition-colors p-1.5 rounded-md focus:outline-none focus:ring-2 focus:ring-primary bg-white/80 dark:bg-black/40 backdrop-blur-sm"
