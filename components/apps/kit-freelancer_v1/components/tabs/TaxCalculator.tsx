      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1">
          <form onSubmit={calculateTaxes}>
            <Card title={t("tax.card.title")}>
              <div className="space-y-6">
                <Input 
                  label={t("tax.monthlyRevenue.label")}
                  type="number" 
                  name="monthlyRevenue"
                ...
                <Input 
                  label={t("tax.serviceValue.label")}
                  type="number" 
                  name="serviceValue"
        ...
        <div className="lg:col-span-2">
          {result ? (
            <div role="status" aria-live="polite" className="space-y-6 animate-fadeIn">
              <Card title={t("tax.results.title")}>
