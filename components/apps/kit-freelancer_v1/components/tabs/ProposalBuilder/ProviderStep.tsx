  ...
  return (
    <div className="animate-fadeIn space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Input
          label={t("proposalBuilder.provider.name")}
          name="providerName"
        ...
        />
        <Input
          label={t("proposalBuilder.provider.company")}
        ...
        />
         <Input
          label={t("proposalBuilder.provider.document")}
        ...
        />
        <Input
          label={t("proposalBuilder.provider.email")}
          name="providerEmail"
          type="email"
        ...
        />
        <Input
          label={t("proposalBuilder.provider.phone")}
          name="providerPhone"
          type="tel"
        ...
        />
        <Input
          label={t("proposalBuilder.provider.address")}
