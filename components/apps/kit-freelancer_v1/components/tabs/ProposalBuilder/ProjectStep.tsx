...
const ProjectStep: React.FC<ProjectStepProps> = ({ data, onChange, onItemsChange }) => {
  ...
  return (
    <div className="animate-fadeIn space-y-6">
      {/* --- Project Details --- */}
      <Input
        label={t("proposalBuilder.project.title")}
        name="projectTitle"
      ...
      <Textarea
        label={t('proposalBuilder.project.introduction')}
        name="introduction"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Input
            label={t("proposalBuilder.project.issueDate")}
            name="issueDate"
            type="date"
        ...
        />
        <Input
            label={t("proposalBuilder.project.validUntil")}
            name="validUntil"
            type="date"
        ...
        />
         <div>
            ...
            <select 
                ...
                value={data.currency} 
                onChange={handleChange} 
                className="w-full p-2 border rounded-md bg-light-input dark:bg-dark-input text-light-text dark:text-dark-text border-light-border dark:border-dark-border transition duration-200 ease-in-out focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-opacity-50 focus-visible:border-primary"
            >
              ...
              <div key={item.id} className="p-4 bg-light-bg dark:bg-dark-bg rounded-lg border border-light-border dark:border-dark-border relative group">
                   <div className="absolute top-4 right-4">
                    <button 
                        ...
                        className="p-2 text-light-muted hover:text-danger transition-colors rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-danger"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div className="md:col-span-6">
                             <Input
                                label={t("proposalBuilder.items.name")}
                                value={item.name}
                        ...
                        <div className="md:col-span-2">
                             <Input
                                label={t("proposalBuilder.items.quantity")}
                                type="number"
                                value={item.quantity}
                         ...
                         <div className="md:col-span-4">
                             <Input
                                label={t("proposalBuilder.items.unitPrice")}
                                type="number"
                        ...
                        <div className="md:col-span-12">
                            <Input
                                label={t("proposalBuilder.items.description")}
