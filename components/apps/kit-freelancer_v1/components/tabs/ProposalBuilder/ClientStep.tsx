  ...
  return (
    <div className="animate-fadeIn space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Input
          label={t("proposalBuilder.client.name")}
          name="clientName"
        ...
        />
        <Input
          label={t("proposalBuilder.client.company")}
          name="clientCompany"
        ...
        />
        <Input
          label={t("proposalBuilder.client.document")}
          name="clientDocument"
        ...
        />
        <Input
          label={t("proposalBuilder.client.email")}
          name="clientEmail"
          type="email"
        ...
        />
         <div className="md:col-span-2">
            <Input
            label={t("proposalBuilder.client.address")}
            name="clientAddress"
