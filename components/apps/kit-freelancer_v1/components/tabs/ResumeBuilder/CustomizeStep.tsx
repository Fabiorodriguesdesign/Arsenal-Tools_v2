                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {templates.map(tpl => (
                         <button
                            ...
                            className={`relative flex flex-col items-center p-2 rounded-lg border-2 transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary dark:focus-visible:ring-offset-dark-bg ${data.templateId === tpl.id ? 'border-accent-blue bg-accent-blue/5' : 'border-light-border dark:border-dark-border hover:border-gray-300 dark:hover:border-gray-600'}`}
                         >
                            ...
                            <span className={`text-sm font-medium ${data.templateId === tpl.id ? 'text-accent-blue dark:text-accent-purple' : 'text-light-muted dark:text-dark-muted'}`}>
                    ...
                    <div className="flex gap-3 flex-wrap">
                        {colors.map(color => (
                            <button
                                ...
                                className={`w-8 h-8 rounded-full border-2 transition-transform hover:scale-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary dark:focus-visible:ring-offset-dark-bg ${data.primaryColor === color ? 'border-gray-400 ring-2 ring-offset-2 ring-primary' : 'border-transparent'}`}
                    ...
                    <div className="flex flex-wrap gap-2">
                        {languages.map(l => (
                            <button
                                ...
                                className={`flex items-center gap-2 px-3 py-2 rounded-md border transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary dark:focus-visible:ring-offset-dark-bg ${data.lang === l.id ? 'border-accent-blue bg-accent-blue/10 text-accent-blue' : 'border-light-border dark:border-dark-border text-light-muted hover:bg-light-bg dark:hover:bg-dark-card'}`}
                            >
