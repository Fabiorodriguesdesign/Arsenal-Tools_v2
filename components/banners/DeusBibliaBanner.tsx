...
const DeusBibliaBanner: React.FC<BannerProps> = ({ href, title, description, iconName = "deus-biblia" }) => {
  const accentColor = '#eab308'; // Gold
  ...
  return (
    ...
    >
        ...
        <div 
            ...
            style={{ background: `linear-gradient(to bottom, #facc15, #a16207)` }}
        ></div>
        ...
        <div className="flex-shrink-0 relative z-10">
            <div 
                className="w-20 h-20 sm:w-24 sm:h-24 bg-yellow-500/5 rounded-3xl flex items-center justify-center border border-yellow-500/10 dark:border-white/5 group-hover:border-yellow-500/20 dark:group-hover:border-yellow-500/30 transition-all duration-500 shadow-lg"
            >
                 <Icon name={iconName} className="w-10 h-10 sm:w-12 sm:h-12 drop-shadow-lg text-yellow-500" />
            </div>
        </div>
        ...
        <div className="flex-grow text-center sm:text-left z-10 flex flex-col justify-center gap-2">
            <div className="flex justify-center sm:justify-start">
                <span className="text-[10px] font-bold uppercase tracking-widest text-yellow-500 bg-yellow-500/10 px-2 py-1 rounded w-fit border border-yellow-500/20 mb-1">
                    Ebook
                </span>
            </div>
            <h3 className="text-2xl sm:text-3xl font-bold text-light-text dark:text-white tracking-tight group-hover:text-yellow-500 transition-colors duration-300">
                {title}
            </h3>
        ...
        <div className="flex-shrink-0 relative z-10 mt-2 sm:mt-0">
             ...
             >
                <div className="w-full h-full rounded-full flex items-center justify-center border border-transparent transition-colors">
                    <Icon name="arrow-right" className="w-6 h-6 sm:w-7 sm:h-7 text-light-muted dark:text-zinc-400 transition-all duration-500 group-hover:-rotate-45 group-hover:text-yellow-500" />
                </div>
             </div>
        </div>
    </a>
...
export default DeusBibliaBanner;