...
const AtividadesBiblicasBanner: React.FC<BannerProps> = ({ href, title, description }) => {
  ...
  return (
    ...
    >
        ...
        <div 
            ...
            style={{ background: `linear-gradient(to bottom, #f472b6, #db2777)` }}
        ></div>
        ...
        <div className="flex-shrink-0 relative z-10">
            <div 
                className="w-20 h-20 sm:w-24 sm:h-24 bg-pink-500/5 rounded-3xl flex items-center justify-center border border-pink-500/10 dark:border-white/5 group-hover:border-pink-500/20 dark:group-hover:border-pink-500/30 transition-all duration-500 shadow-lg"
            >
                 <Icon name="atividades-biblicas" className="w-10 h-10 sm:w-12 sm:h-12 drop-shadow-lg text-pink-500" />
            </div>
        </div>
        ...
        <div className="flex-grow text-center sm:text-left z-10 flex flex-col justify-center gap-2">
            <div className="flex justify-center sm:justify-start">
                <span className="text-[10px] font-bold uppercase tracking-widest text-pink-500 bg-pink-500/10 px-2 py-1 rounded w-fit border border-pink-500/20 mb-1">
                    Kids
                </span>
            </div>
            <h3 className="text-2xl sm:text-3xl font-bold text-light-text dark:text-white tracking-tight group-hover:text-pink-500 transition-colors duration-300">
                {title}
            </h3>
        ...
        <div className="flex-shrink-0 relative z-10 mt-2 sm:mt-0">
             ...
             >
                <div className="w-full h-full rounded-full flex items-center justify-center border border-transparent transition-colors">
                    <Icon name="arrow-right" className="w-6 h-6 sm:w-7 sm:h-7 text-light-muted dark:text-zinc-400 transition-all duration-500 group-hover:-rotate-45 group-hover:text-pink-500" />
                </div>
             </div>
        </div>
    </a>
...
export default AtividadesBiblicasBanner;