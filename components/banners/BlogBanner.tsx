...
const BlogBanner: React.FC<BlogBannerProps> = ({ href, title, description }) => {
  const accentColor = 'var(--color-primary)'; // Primary Red
  ...
  return (
    ...
    >
        ...
        <div 
            ...
            style={{ background: `linear-gradient(to bottom, ${accentColor}, #ff5e00)` }}
        ></div>
        ...
        <div className="flex-shrink-0 relative z-10">
            <div 
                className="w-20 h-20 sm:w-24 sm:h-24 bg-primary/5 rounded-3xl flex items-center justify-center border border-primary/10 dark:border-white/5 group-hover:border-primary/20 dark:group-hover:border-primary/30 transition-all duration-500 shadow-lg"
            >
                <Icon name="blog-fe" className="w-10 h-10 sm:w-12 sm:h-12 drop-shadow-lg text-primary" />
            </div>
        </div>
        ...
        <div className="flex-grow text-center sm:text-left z-10 flex flex-col justify-center gap-2">
            <div className="flex justify-center sm:justify-start">
                <span className="text-[10px] font-bold uppercase tracking-widest text-red-500 bg-red-500/10 px-2 py-1 rounded w-fit border border-red-500/20 mb-1">
                    Blog
                </span>
            </div>
            <h3 className="text-2xl sm:text-3xl font-bold text-light-text dark:text-white tracking-tight group-hover:text-primary transition-colors duration-300">
                {title}
            </h3>
        ...
        <div className="flex-shrink-0 relative z-10 mt-2 sm:mt-0">
             ...
             >
                <div className="w-full h-full rounded-full flex items-center justify-center border border-transparent transition-colors">
                    <Icon name="arrow-right" className="w-6 h-6 sm:w-7 sm:h-7 text-light-muted dark:text-zinc-400 transition-all duration-500 group-hover:-rotate-45 group-hover:text-primary" />
                </div>
             </div>
        </div>
    </a>
